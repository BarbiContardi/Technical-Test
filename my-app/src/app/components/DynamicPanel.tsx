...
export const DynamicPanel: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-center mt-8">
      ...
      <div
        className={`bg-gray-200 box-content p-4 rounded-md shadow-md transition-opacity transition-height duration-300 ease-out ${isPanelVisible ? 'opacity-100 h-auto' : 'opacity-0 h-0'}`}
      >
